...
- `lastPublished`: `2026-09-07T15:23:12.545Z`
- `googleTagIds`: `[]`

Hard-refresh desktop 1440, no injected CSS: `.home_service_transition` height `630px` (`70svh`), `linear-gradient(rgba(11, 11, 12, 0), rgba(11, 11, 12, 0.45) 72%, rgb(11, 11, 12))`. 80%/92% absent. Hero `fixed` / `0`. Inner `relative`. Service `z-index: 30`, bg `rgb(11, 11, 12)`.
